...
namespace Boa.Constrictor.UnitTests.Safety
{
    ...
    public class SafeActionsTest
    {
        ...
        public const string Message_OneFailure = "(1) Expected value to be 0, but found 2.";
        public const string Message_ManyFailures = "(1) Expected value to be 0, but found 1.; (2) Expected value to be 0, but found 2.";
