...
{
    public class HtmlAttributeListTest : BaseWebLocatorQuestionTest
    {
        #region Tests
        ...
        public void TestSingleElement()
        {
            ...
            List<string> list = Actor.AsksFor(HtmlAttributeList.For(Locator, "name")).ToList();
        ...
        public void TestMultipleElements()
        {
            ...
            var list = Actor.AsksFor(HtmlAttributeList.For(Locator, "name")).ToList();
        ...
        public void TestNoElements()
        {
            ...
            Actor.Invoking(x => x.AsksFor(HtmlAttributeList.For(Locator, "name"))).Should().Throw<WaitingException<bool>>();
        }
