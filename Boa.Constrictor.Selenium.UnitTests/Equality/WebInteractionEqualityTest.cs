...
namespace Boa.Constrictor.Selenium.UnitTests
{
    ...
    public class WebInteractionEqualityTest
    {
        ...
        private static readonly IWebLocator ShadowLocatorA = ShadowLocator.S("shadow hello", By.CssSelector("my-host"), By.CssSelector("input"));
        private static readonly IWebLocator ShadowLocatorA1 = ShadowLocator.S("shadow hello", By.CssSelector("my-host"), By.CssSelector("input"));
        private static readonly IWebLocator ShadowLocatorB = ShadowLocator.S("shadow hello", By.CssSelector("other-host"), By.CssSelector("input"));
        ...
        private static readonly object[] SameInteractions =
        {
            ...
            new object[] { Appearance.Of(ShadowLocatorA), Appearance.Of(ShadowLocatorA1) },
            ...
            new object[] { Classes.Of(ShadowLocatorA), Classes.Of(ShadowLocatorA1) },
            new object[] { Count.Of(LocatorA), Count.Of(LocatorA1) },
            new object[] { Count.Of(ShadowLocatorA), Count.Of(ShadowLocatorA1) },
            new object[] { CssValue.Of(LocatorA, "property"), CssValue.Of(LocatorA1, "property") },
            new object[] { CssValue.Of(ShadowLocatorA, "property"), CssValue.Of(ShadowLocatorA1, "property") },
            ...
            new object[] { DomProperty.Of(ShadowLocatorA, "property"), DomProperty.Of(ShadowLocatorA1, "property") },
            new object[] { EnabledState.Of(LocatorA), EnabledState.Of(LocatorA1) },
            new object[] { EnabledState.Of(ShadowLocatorA), EnabledState.Of(ShadowLocatorA1) },
            new object[] { Existence.Of(LocatorA), Existence.Of(LocatorA1) },
            new object[] { Existence.Of(ShadowLocatorA), Existence.Of(ShadowLocatorA1) },
            new object[] { HtmlAttribute.Of(LocatorA, "property"), HtmlAttribute.Of(LocatorA1, "property") },
            new object[] { HtmlAttribute.Of(ShadowLocatorA, "property"), HtmlAttribute.Of(ShadowLocatorA1, "property") },
            ...
            new object[] { JavaScript.On(ShadowLocatorA, "script"), JavaScript.On(ShadowLocatorA1, "script") },
            ...
            new object[] { JavaScriptText.Of(ShadowLocatorA), JavaScriptText.Of(ShadowLocatorA1) },
            new object[] { Location.Of(LocatorA), Location.Of(LocatorA1) },
            new object[] { Location.Of(ShadowLocatorA), Location.Of(ShadowLocatorA1) },
            new object[] { PixelSize.Of(LocatorA), PixelSize.Of(LocatorA1) },
            new object[] { PixelSize.Of(ShadowLocatorA), PixelSize.Of(ShadowLocatorA1) },
            ...
            new object[] { SelectedState.Of(ShadowLocatorA), SelectedState.Of(ShadowLocatorA1) },
            ...
            new object[] { TagName.Of(ShadowLocatorA), TagName.Of(ShadowLocatorA1) },
            new object[] { Text.Of(LocatorA), Text.Of(LocatorA1) },
            new object[] { Text.Of(ShadowLocatorA), Text.Of(ShadowLocatorA1) },
            ...
            new object[] { Clear.On(ShadowLocatorA), Clear.On(ShadowLocatorA1) },
            new object[] { Click.On(LocatorA), Click.On(LocatorA1) },
            new object[] { Click.On(ShadowLocatorA), Click.On(ShadowLocatorA1) },
            new object[] { Hover.Over(LocatorA), Hover.Over(LocatorA1) },
            new object[] { Hover.Over(ShadowLocatorA), Hover.Over(ShadowLocatorA1) },
            new object[] { JavaScriptClick.On(LocatorA), JavaScriptClick.On(LocatorA1) },
            new object[] { JavaScriptClick.On(ShadowLocatorA), JavaScriptClick.On(ShadowLocatorA1) },
            ...
            new object[] { ScrollContainer.Reset(ShadowLocatorA), ScrollContainer.Reset(ShadowLocatorA1) },
            ...
            new object[] { ScrollToElement.At(ShadowLocatorA), ScrollToElement.At(ShadowLocatorA1) },
            ...
            new object[] { SendKeys.To(ShadowLocatorA, "hello"), SendKeys.To(ShadowLocatorA1, "hello") },
            ...
            new object[] { Submit.On(ShadowLocatorA), Submit.On(ShadowLocatorA1) },
            ...
            new object[] { WaitAndRefresh.For(ShadowLocatorA), WaitAndRefresh.For(ShadowLocatorA1) },
        ...
        private static readonly object[] DifferentInteractions =
        {
            ...
            new object[] { Appearance.Of(ShadowLocatorA), Appearance.Of(ShadowLocatorB) },
            ...
            new object[] { Classes.Of(ShadowLocatorA), Classes.Of(ShadowLocatorB) },
            new object[] { Count.Of(LocatorA), Title.OfPage() },
            new object[] { Count.Of(LocatorA), Count.Of(LocatorB) },
            new object[] { Count.Of(ShadowLocatorA), Count.Of(ShadowLocatorB) },
            ...
            new object[] { CssValue.Of(ShadowLocatorA, "property"), CssValue.Of(ShadowLocatorB, "property") },
            ...
            new object[] { DomProperty.Of(ShadowLocatorA, "property"), DomProperty.Of(ShadowLocatorB, "property") },
            ...
            new object[] { EnabledState.Of(ShadowLocatorA), EnabledState.Of(ShadowLocatorB) },
            new object[] { Existence.Of(LocatorA), Title.OfPage() },
            new object[] { Existence.Of(LocatorA), Existence.Of(LocatorB) },
            new object[] { Existence.Of(ShadowLocatorA), Existence.Of(ShadowLocatorB) },
            ...
            new object[] { HtmlAttribute.Of(ShadowLocatorA, "property"), HtmlAttribute.Of(ShadowLocatorB, "property") },
            ...
            new object[] { JavaScript.On(ShadowLocatorA, "script"), JavaScript.On(ShadowLocatorB, "script") },
            ...
            new object[] { JavaScriptText.Of(ShadowLocatorA), JavaScriptText.Of(ShadowLocatorB) },
            new object[] { Location.Of(LocatorA), Title.OfPage() },
            new object[] { Location.Of(LocatorA), Location.Of(LocatorB) },
            new object[] { Location.Of(ShadowLocatorA), Location.Of(ShadowLocatorB) },
            new object[] { PixelSize.Of(LocatorA), Title.OfPage() },
            new object[] { PixelSize.Of(LocatorA), PixelSize.Of(LocatorB) },
            new object[] { PixelSize.Of(ShadowLocatorA), PixelSize.Of(ShadowLocatorB) },
            ...
            new object[] { SelectedState.Of(ShadowLocatorA), SelectedState.Of(ShadowLocatorB) },
            ...
            new object[] { TagName.Of(ShadowLocatorA), TagName.Of(ShadowLocatorB) },
            new object[] { Text.Of(LocatorA), Title.OfPage() },
            new object[] { Text.Of(LocatorA), Text.Of(LocatorB) },
            new object[] { Text.Of(ShadowLocatorA), Text.Of(ShadowLocatorB) },
            ...
            new object[] { JavaScriptClick.On(ShadowLocatorA), JavaScriptClick.On(ShadowLocatorB) },
            ...
            new object[] { ScrollContainer.Reset(ShadowLocatorA), ScrollContainer.Reset(ShadowLocatorB) },
            ...
            new object[] { ScrollToElement.At(ShadowLocatorA), ScrollToElement.At(ShadowLocatorB) },
            ...
            new object[] { SendKeys.To(ShadowLocatorA, "hello"), SendKeys.To(ShadowLocatorB, "hello") },
            ...
            new object[] { Submit.On(ShadowLocatorA), Submit.On(ShadowLocatorB) },
            ...
            new object[] { WaitAndRefresh.For(ShadowLocatorA), WaitAndRefresh.For(ShadowLocatorB) },
