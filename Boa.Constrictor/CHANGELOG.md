...
[`Boa.Constrictor`](https://www.nuget.org/packages/Boa.Constrictor) project and its unit tests
...
- Bumped version of constituent package
...
- Bumped versions of constituent packages
...
- Updated `Boa.Constrictor.RestSharp` to 3.2.0
...
- Fixed `CurrentScreenshotTest` tests to run on non-Windows systems
